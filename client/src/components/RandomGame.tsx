    ...
    return (
      <div className="card p-4 animate-fade-in">
        <div className="flex items-start gap-3 mb-3">
          <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ background: `${suggestion.color}12` }}>
            <div className="w-3 h-3 rounded-full" style={{ background: suggestion.color, opacity: 0.7 }} />
          </div>
          <div className="min-w-0">
            <p className="text-[10px] text-text-muted font-medium mb-0.5">Рекомендуем</p>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 py-2.5 btn-primary text-[12px]"
          >
            Посмотреть аккаунты
          </button>
          <button
            onClick={pick}
            className="px-4 py-2.5 btn-secondary text-[12px]"
          >
            Другую
          </button>
        </div>
