  ...
  return (
    <div className="mb-5">
      <div className="px-5 mb-2.5">
        <h3 className="text-[13px] font-semibold text-text-secondary tracking-wide">Избранные</h3>
      </div>
      <div className="flex gap-2 overflow-x-auto px-5 pb-1 scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
        {favGames.map((game) => (
          <button
            ...
            className="shrink-0 px-3.5 py-2 rounded-lg bg-surface-2 border border-white/[0.04] text-[12px] font-medium active:scale-95 transition-transform"
          >
            {game.name}
          </button>
        ))}
